...
## slots    
\_\_slots__是一个类变量，\_\_slots__属性可以赋值一个包含类属性名的字符串元组，或者是可迭代变量，或者    
是一个字符串，只要在类定义的时候，使用__slots__ = a Tuple来定义该属性就可以了    
...
https://www.jianshu.com/p/2a17957cefe7    
https://www.jianshu.com/p/e558cd735f18    
